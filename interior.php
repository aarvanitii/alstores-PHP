    ...
    <div class="container">
        ...
        <div class="row services">
            ...
            foreach ($workshops as $workshop) {
                if ($workshop['productType'] == 'interior') {
                    ...
                    if(isset($_SESSION['user_id'])){
                        ...
                        echo '<img id="open-modal" class="thumbnail img-responsive" onclick="modalFunction(\'' . $image . '\')" data-toggle="modal" data-target="#my_modal" src="public/resources/img/work/' . $workshop['image'] . '">
				    </div>';
                }
            }
            ?>
